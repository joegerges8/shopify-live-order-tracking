...
const TOWN_TO_AREA = {
  ...
  // Freike, the upper-Metn village between Qornet el Hamra and Beit Chabab.
  // One real order spelled it two ways in the same checkout ("Fraikeh" as the
  // city, "Friekeh" in the address), so the variants are seeded as generously
  // as the other towns'.
